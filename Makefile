# This Makefile is for the PGObject::Simple::Role extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/PGObject/Simple/Role.pm]
...
MAKE = make
FULLEXT = PGObject/Simple/Role
BASEEXT = Role
PARENT_NAME = PGObject::Simple
DLBASE = $(BASEEXT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/PGObject/Simple/Role.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/PGObject/Simple
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/PGObject/Simple
...
TO_INST_PM = lib/PGObject/Simple/Role.pm

PM_TO_BLIB = lib/PGObject/Simple/Role.pm \
...
DISTVNAME = PGObject-Simple-Role-0.51
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/PGObject/Simple/Role.pm $(INST_MAN3DIR)/PGObject::Simple::Role.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''Moo/Moose mappers for minimalist PGObject framework'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: PGObject-Simple-Role' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "Moo/Moose mappers for minimalist PGObject framework",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "PGObject-Simple-Role",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   "version" : "0.51"' >> META_new.json
	$(NOECHO) $(ECHO) '}' >> META_new.json
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/PGObject/Simple/Role.pm blib/lib/PGObject/Simple/Role.pm 
